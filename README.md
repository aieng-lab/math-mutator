...
This repository contains the official source code for the dataset generation of [MAMUT: A Novel Framework for Modifying Mathematical Formulas for the Generation of Specialized Datasets for Language Model Training](https://openreview.net/forum?id=khODmRpQEx), published in Transactions on Machine Learning Research 2025.
